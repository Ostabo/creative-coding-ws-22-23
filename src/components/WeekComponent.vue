  ...
  <v-lazy v-model="active"
    ...
    <v-responsive max-width="1550px">
      ...
      <v-row v-for="person in json?.people?.filter(p => hasSomething(p))"
        ...
        <v-card v-for="img in person.img" class="ma-1" elevation="0" height="220" min-width="300" rounded="0"
                width="380"
        ...
        <v-card v-for="pdf in person.pdf" class="ma-1" elevation="0" height="220" min-width="300" rounded="0"
                width="380"
